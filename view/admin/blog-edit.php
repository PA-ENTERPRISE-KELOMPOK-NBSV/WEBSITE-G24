...
if(isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($_FILES['gambar']) && $_FILES['gambar']['error'] === UPLOAD_ERR_OK) {
            ...
            move_uploaded_file($_FILES['gambar']['tmp_name'], '../../blog_post/' . uniqid() . '_' . $gambar);
        } else {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                ...
                                                <div class="multiple-file-upload">
                                                    <input type="file" class="custom-file-input" name="gambar" id="gambar" onchange="displayImage(this)">
                                                </div>
                                                <?php
                                                if(!empty($row_blog['gambar'])) {
        ...
        function displayImage(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    $('#preview-image').css('display', 'block'); // Menampilkan gambar yang di-preview
                }
